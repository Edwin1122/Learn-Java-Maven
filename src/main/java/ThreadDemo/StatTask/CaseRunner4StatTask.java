...
public class CaseRunner4StatTask {

    public static void main(String[] args) throws Exception {
        AppWrapper.invokeMain0(CaseRunner4StatTask.class, args, false);
    }
    ...
    private static InputStream createInputStream() {
        ...
        InputStream dataIn = CaseRunner4StatTask.class.getResourceAsStream("/data/ch4case02/in.dat");
        ...
        SequenceInputStream si = new SequenceInputStream(
                new Enumeration<InputStream>() {
                    ...
                    public InputStream nextElement() {
                        ...
                        if (null != fileName) {
                            try {
                                in = CaseRunner4StatTask.class.getResourceAsStream("/data/ch4case02/" + fileName);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
